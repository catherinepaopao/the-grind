...
public class GameData {
    ...
    // placeholder data that we plan to move to server
    ...
    public static String[] placeholderLeaderboard = {"Bob@25037", "Jack@125037", "Llama@17037", "Flash@31517037", ""}; // placeholder obv
    public static long[] totalTimes = {-1, -1, -1, -1};
}
